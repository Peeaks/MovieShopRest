...
namespace MovieShop {
    ...
    public class ApplicationUserManager : UserManager<Customer> {
        public ApplicationUserManager(IUserStore<Customer> store) : base(store) {
        }

        public static ApplicationUserManager Create(IdentityFactoryOptions<ApplicationUserManager> options,
            IOwinContext context) {
            var manager = new ApplicationUserManager(new UserStore<Customer>(context.Get<MovieShopContext>()));
