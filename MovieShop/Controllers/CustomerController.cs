...
namespace MovieShop.Controllers {
    ...
    public class CustomerController : ApiController {
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model) {
            ...
            var user = new Customer() {UserName = model.Email, Email = model.Email, FirstName = model.FirstName, LastName = model.LastName, Address = model.Address};
        ...
        //GET : api/Customers/GetUserLoggedIn
        [Route("GetUserLoggedIn")]
        public IHttpActionResult GetUserLoggedIn() {
            var username = HttpContext.Current.User.Identity.Name;
            var c = db.Users.Include(x => x.Address).FirstOrDefault(x => x.Email == username);
            if (c == null) {
                return NotFound();
            }
            return Ok(c);
        ...
        public IHttpActionResult PutCustomer(string id, Customer customer) {
            ...
            if (HttpContext.Current.User.Identity.Name != customer.Email) {
            ...
            var customerInDb = db.Users.Include(x => x.Address).FirstOrDefault(x => x.Id == id);
